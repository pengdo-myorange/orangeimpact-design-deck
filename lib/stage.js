...
(function(){
  ...
  // Navigation is keyboard-only (←/→, Space, PageUp/PageDown, Home/End).
  // Click/tap/swipe intentionally does nothing so users can't accidentally
  // advance the deck by clicking on the slide.
