...
.sl-title-stack .sl-title-image { border-radius: var(--radius-xl); background-size: contain; background-position: center; background-repeat: no-repeat; background-color: var(--bg-muted); box-shadow: var(--shadow-md); min-height: 0; }
