...
function renderTitle(slide, ctx) {
  ...
  if (img) {
    ...
    const imgHtml = src
      ? `<div class="sl-title-image" style="background-image:url('${src}')"></div>`
      : `<div class="sl-title-image sl-title-image-empty"></div>`;
    return wrap(
      slide,
      ctx,
...
function renderClosing(slide, ctx) {
  ...
  return wrap(
    slide,
    ctx,
    `<div class="sl-closing-body"><h1 class="sl-closing-hero">${inline(h1 ? h1.text : "Thank you")}</h1><div class="sl-closing-meta">${meta}</div></div>`
  );
}
...
.sl-title-stack .sl-title-image { border-radius: var(--radius-xl); background-size: cover; background-position: center; background-repeat: no-repeat; background-color: var(--bg-muted); box-shadow: var(--shadow-md); min-height: 0; }
...
.sl-statement-sub { font-size: 40px; line-height: 1.4; color: var(--fg-alternative); margin: 0; max-width: 1200px; }
...
.sl-quote-mark { font-size: var(--deck-heading-l); line-height: 1.38; font-weight: 500; color: var(--fg-strong); margin: 0; padding: 0; max-width: 1500px; position: relative; }
...
.sl-bignum-hero { font-size: 224px; line-height: var(--deck-number-mega-lh); font-weight: 800; color: var(--brand); letter-spacing: -4.8px; font-feature-settings: "tnum" 1, "lnum" 1; margin-top: 48px; }
.sl-bignum-lead { font-size: 40px; line-height: 1.5; color: var(--fg-strong); max-width: 1400px; margin: 0; font-weight: 500; }
