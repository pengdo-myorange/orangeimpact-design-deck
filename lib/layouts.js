...
/* Title slide: place logo a touch larger and lower */
.sl.sl-title .sl-logo { top: 56px; right: 72px; height: 32px; }
/* Section divider (orange bg): logo white, slightly larger */
.sl.sl-section-divider .sl-logo { height: 32px; }
...
.sl-title-meta { margin-top: 64px; font-size: 26px; line-height: 1.5; color: var(--fg-assistive); font-weight: 500; }
