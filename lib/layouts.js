...
.sl-title-sub { margin-top: 32px; font-size: 32px; line-height: 1.3; color: var(--fg-alternative); font-weight: 500; }
.sl-title-meta { margin-top: 64px; font-size: 18px; color: var(--fg-assistive); font-weight: 500; }
...
.sl-statement-hero { font-size: 140px; line-height: 1.1; font-weight: 800; color: var(--fg-strong); margin: 0; letter-spacing: -3px; max-width: 1600px; }
...
.sl-toc-item { display: flex; align-items: baseline; gap: 24px; padding: 12px 0; border-bottom: 1px solid var(--border-subtle); font-size: 24px; }
.sl-toc-num { color: var(--brand); font-weight: 700; font-feature-settings: "tnum" 1; min-width: 56px; }
.sl-toc-label { color: var(--fg-strong); flex: 1; font-weight: 500; }
.sl-toc-page { color: var(--fg-assistive); font-size: 18px; font-feature-settings: "tnum" 1; }
...
.sl-closing-meta p { font-size: 24px; color: var(--fg-alternative); margin: 8px 0; }
...
.sl-quote-cite { display: block; margin-top: 48px; font-size: 24px; color: var(--fg-alternative); font-style: normal; font-weight: 500; padding-left: 4px; }
...
.sl-image-caption { margin-top: 16px; font-size: 16px; color: var(--fg-assistive); }
.sl-figure { margin: 16px 0; }
.sl-figure img { max-width: 100%; height: auto; border-radius: var(--radius-md); }
.sl-figure figcaption { margin-top: 8px; font-size: 14px; color: var(--fg-assistive); }

/* ============================================================
   Big Number
   ============================================================ */
.sl-bignum-body { padding: 140px 160px 100px; gap: 32px; }
.sl-bignum-hero { font-size: var(--deck-number-mega); line-height: var(--deck-number-mega-lh); font-weight: 800; color: var(--brand); letter-spacing: -6px; font-feature-settings: "tnum" 1, "lnum" 1; }
...
.sl-bignum-q-text { font-size: 20px; line-height: 1.5; color: var(--fg-strong); font-style: italic; }
.sl-bignum-quote cite { display: block; margin-top: 12px; font-size: 16px; color: var(--fg-alternative); font-style: normal; }
...
.sl-stats-cell .sl-stats-body { font-size: 18px; line-height: 1.5; color: var(--fg-normal); padding: 0; }
...
.sl-chart-legend-item { display: grid; grid-template-columns: 32px 1fr auto; gap: 20px; align-items: center; padding: 12px 0; border-bottom: 1px solid var(--border-subtle); font-size: 20px; }
...
.sl-compare-label { font-size: 14px; font-weight: 700; letter-spacing: 1px; text-transform: uppercase; }
...
.sl-compare-card ul li { font-size: 18px; line-height: 1.6; color: var(--fg-normal); }
...
.sl-bento-label { font-size: 14px; font-weight: 700; letter-spacing: 1px; color: var(--brand); text-transform: uppercase; }
.sl-bento-title { font-size: 24px; font-weight: 700; color: var(--fg-strong); margin: 0; }
...
.sl-chain-title { font-size: 24px; font-weight: 700; color: var(--fg-strong); margin: 0; }
...
.sl-timeline-label { font-size: 16px; font-weight: 700; color: var(--fg-strong); margin-top: 8px; }
.sl-timeline-active .sl-timeline-label { color: var(--brand); }
.sl-timeline-body { display: flex; flex-direction: column; }
.sl-timeline-item .sl-timeline-body { font-size: 14px; line-height: 1.5; color: var(--fg-alternative); padding: 0; max-width: 280px; }
...
.sl-process-num { background: var(--neutral-900); color: var(--fg-on-brand); font-size: 14px; font-weight: 700; padding: 6px 12px; border-radius: var(--radius-pill); font-feature-settings: "tnum" 1; }
.sl-process-highlight .sl-process-num { background: var(--brand); }
.sl-process-title { font-size: 18px; font-weight: 700; color: var(--fg-strong); }
.sl-process-body { font-size: 14px; line-height: 1.5; color: var(--fg-alternative); padding: 0; }
...
.sl-profile-bullets li { font-size: 18px; line-height: 1.6; margin-bottom: 8px; color: var(--fg-normal); }
...
.sl-prompt-chip { background: var(--bg-brand-tint); color: var(--brand); padding: 8px 20px; border-radius: var(--radius-pill); font-size: 14px; font-weight: 700; align-self: flex-start; letter-spacing: 0.5px; text-transform: uppercase; }
...
.sl-prompt-variant { background: var(--brand); color: var(--fg-on-brand); padding: 4px 12px; border-radius: var(--radius-sm); font-size: 12px; font-weight: 700; align-self: flex-start; text-transform: uppercase; letter-spacing: 0.5px; }
.sl-prompt-code { background: var(--neutral-950); color: #E5E5E5; padding: 32px; border-radius: var(--radius-lg); margin: 0; font-family: "SF Mono", Menlo, monospace; font-size: 16px; line-height: 1.6; overflow: hidden; flex: 1; white-space: pre-wrap; }
.sl-prompt-response { background: var(--bg-canvas); border: 1px solid var(--border-subtle); border-radius: var(--radius-lg); padding: 32px; box-shadow: var(--shadow-sm); flex: 1; font-size: 16px; line-height: 1.6; }
.sl-prompt-analysis { padding: 16px 24px; border-left: 4px solid var(--brand); }
.sl-prompt-analysis-h { font-size: 18px; font-weight: 700; color: var(--brand); margin: 0 0 8px; }
...
.sl-cp-name { font-size: 22px; font-weight: 700; color: var(--fg-strong); }
.sl-cp-sub { font-size: 16px; color: var(--fg-alternative); margin-top: 4px; }
